...
import { Box, Flex, Textarea, useBoolean, Button } from '@chakra-ui/react';
            ...
            <MyTooltip label={fileList.length > 0 ? '请先删除文件再开启联网搜索' : '联网搜索'}>
              {getNetworkSearch(appId) ? (
                ...
                >
                  <Button
                    leftIcon={
                      <MyIcon name={'core/chat/networkIcon'} w={'19px'} color={'#707070'} />
                    }
                    color={'#707070'}
                    borderColor="#707070"
                    variant="outline"
        ...
        <Flex alignItems={'center'} gap={[0, 1]}>
          ...
          <Flex alignItems={'center'} h={[8, 9]}>
            ...
            {(showSelectFile || showSelectImg) && (
              ...
              >
                <MyTooltip
                  label={getNetworkSearch(appId) ? '联网搜索不支持上传文件' : selectFileLabel}
                >
